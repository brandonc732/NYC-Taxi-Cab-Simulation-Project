...
Analysis of fleet simulations and their distance distributions is completed with `Analysis_v1.ipynb` and `Analysis_v2.ipynb`. The primary difference between versions is the inclusion of animated heat maps in version 2.
